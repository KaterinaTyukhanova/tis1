describe('Registration Test', () => {
    ...
    it('None-existent password test', () => {
        cy.fixture('cypressRegistration').then(data => {
            ...
            cy.get(':nth-child(1) > :nth-child(3) > .form-control--medium > .form-input--password').type(data.none_existent_password)
    ...
    it('None-existent again-password test', () => {
        cy.fixture('cypressRegistration').then(data => {
            ...
            cy.get(':nth-child(1) > :nth-child(4) > .form-control--medium > .form-input--password').type(data.none_existent_again_password)
    ...
    it('None-existent name test', () => {
        cy.fixture('cypressRegistration').then(data => {
            ...
            cy.get('[style=""] > :nth-child(2) > .form-control--medium > .form-input--text').type(data.none_existent_name)
    ...
    it('None-existent patronymic test', () => {
        cy.fixture('cypressRegistration').then(data => {
            ...
            cy.get('[style=""] > :nth-child(3) > .form-control--medium > .form-input--text').type(data.none_existent_patronym)
