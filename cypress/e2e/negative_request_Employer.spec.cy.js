describe('Request Add Role Employer Test', () => {
    ...
    it('Clear name company test', () => {
        cy.fixture('cypressRequestEmployer').then(data => {
            ...
            cy.log('Удаление введеного текста из поля названия компании')
    ...
    it('Clear address company test', () => {
        cy.fixture('cypressRequestEmployer').then(data => {
            ...
            cy.log('Удаление введеного текста из поля адреса компании')
    ...
    it('Clear description company test', () => {
        cy.fixture('cypressRequestEmployer').then(data => {
            cy.log('Переход на страницу авторизации')
            cy.visit(data.main_url)
            ...
            cy.log('Удаление введеного текста из поля описания компании')
